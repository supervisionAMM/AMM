# This is the PLC4 logic, it's about the very same thing as that in the real plc.
from controlSWaT.logicblock.logicblock import SETD
from controlSWaT.logicblock.logicblock import TONR
from controlSWaT.controlblock.controlblock import *
...
class PLC4:
    ...
    def Pre_Main_RO_Feed_Dosing(self, IO, HMI):
        ...
        if HMI.P4.State == 4:
            ...
            self.Mid_P_NAHSO3_ORP_DUTY_AutoInp = SETD(
                (HMI.P401.Status == 2 or HMI.P402.Status == 2) and (HMI.AIT402.AH),
