# This is the PLC5 logic, it's about the very same thing as that in the real plc.
from  controlSWaT.logicblock.logicblock import *
    ...
    def Pre_Main_High_Pressure_RO(self, IO, HMI, Sec_P, Min_P):
        ...
        while switch(HMI.P5.State):
            ...
            if case(6):
                ...
                if ((HMI.FIT501.Pv > HMI.Cy_P5.HPP_Q_SET_M3H) and (
                        HMI.PIT502.Pv < HMI.PIT503.Pv)) and HMI.PIT501.Pv > 250 or self.Mid_NEXT:
                    self.Mid_NEXT = 0
                    HMI.P5.State = 7
                break
            if case(7):
